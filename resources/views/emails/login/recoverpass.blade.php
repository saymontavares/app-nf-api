				...
				<td>
					<table border="0" width="100%">
						<tr>
							...
							<td>
								<p style="text-align: right;"><a href="" target="_blank" style="text-decoration: none;">View In Website</a></p>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td>
					<table border="0" cellpadding="0" cellspacing="0" style="text-align:center;width:100%;background-color: #fff;">
						...
						<tr>
							<td>
								<h1 style="padding-top:25px;">Nova Senha</h1>
							</td>
						</tr>
						<tr>
							<td>
								<p style="padding:0px 100px;">
									Olá <b>{{strtoupper($usuario->name)}}</b>, guarde bem sua senha ou redefina:
								</p>
								<p>Senha: <b>{{$usuario->newpass}}</b></p>
							</td>
						</tr>
						<tr>
							<td>
								<button style="margin:10px 0px 30px 0px;border-radius:4px;padding:10px 20px;border: 0;color:#fff;background-color:#FF7A5A; ">Login</button>
							</td>
						</tr>
					</table>
				</td>
				...
				<td>
					<table border="0" width="100%" style="border-radius: 5px;text-align: center;">
						...
						<tr>
							<td>
								<div style="margin-top: 20px;">
									<span style="font-size:12px;">Todos os direitos reservados</span><br>
									<span style="font-size:12px;">Copyright © <?php echo date("Y"); ?></span>
								</div>
							</td>
						</tr>
					</table>
